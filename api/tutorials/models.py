...
class Service(models.Model):
    id_service = models.AutoField(verbose_name='ServiceId', primary_key=True, default="n")
    name_service = models.CharField(max_length=70, blank=False, default="0:30:00")
    small_time = models.DurationField(blank=False, default="0:30:00")
    medium_time = models.DurationField(blank=False, default="0:35:00")
    large_time = models.DurationField(blank=False, default="0:40:00")
